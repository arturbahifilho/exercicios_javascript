...
function ehPerfeito(n) {
	...
	if(n % divisor == 0) {
	soma = soma + divisor //variável 'soma' armazena a soma de todos os números divisíveis por 'n'
...
var numero = rs.questionInt('Digite um numero pra saber se e perfeito: ')
